            ...
            <div className="flex items-center gap-6">
                <div className="relative group">
                    ...
                    <input
                        ...
                        onKeyDown={(e) => e.key === 'Enter' && alert(`Executing global search for: "${e.target.value}"`)}
                ...
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => alert('Operational Notifications: 3 Lead Updates, 1 System Log')}
                        className="relative p-2 text-zinc-500 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-50 dark:hover:bg-zinc-800 rounded-full transition-all active:scale-90"
                    >
                        <Bell size={20} />
                    ...
                    <button
                        onClick={() => alert('Accessing Administrator Profile Settings...')}
